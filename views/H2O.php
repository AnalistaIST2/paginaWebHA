    ...
    <main class="flex-shrink-0">
        ...
        <section style="position: fixed; z-index:100;">
            <ul class="nav nav-tabs">
                <li class="nav-item dropdown" style="background:rgba(229,53,23,0.6); border-radius:1px;">
                ...
                <div class="row gx-5">
                    <div class="col-lg-8">
                        ...
                        <article>
                            ...
                            <section class="mb-5">
                                <ul>
                                    <p class=" mb-4">Siendo una de las más actuales técnicas de impresión, en nuestra compañí­a desarrollamos piezas de alta calidad que harán sentir orgullosos a sus clientes con la información que su empresa les desea brindar.
                ...
                <div class="row gx-5">
                    ...
                    <div class="col-lg-8">
                        ...
                        <article>
                            ...
                            <section class="mb-5">
                                <ul>
                                    <p class=" mb-4">Las ideas no pueden ser realidad sin el talento para recrearlas. Por eso H&A CONSULTING LTDA, con su vertical H2O cuenta con diseñadores creativos que hacen sus ideas realidad. El diseño gráfico no es solo desarrollar piezas tales como manuales de identidad corporativa, portafolios, cartillas, manuales de inducción, Ilustraciones, etc., sino que además, le brinda opciones visuales proporcionando soluciones a las necesidades comunicativas que son propias de una organización.
                                        Diseño editorial, ilustración, fotografía, diseño multimedia, son solo algo del la gran gama de posibilidades dentro de la gráfica, las cuales puede explotar para transmitir un mensaje contundente, eficaz y sobre todo visual a sus clientes.
                                </ul>
                            </section>
                        </article>
                        <!-- Comments section-->
                ...
                <div class="row gx-5">
                    ...
                    <div class="col-lg-8">
                        ...
                        <article>
                            ...
                            <section class="mb-5">
                                <ul>
                                    <p class=" mb-4">Buscamos alternativas de comunicación diferentes usando la World Wide Web, los dispositivos móviles y las computadoras como aliados estratégicos. Permítanos darle un nuevo aire a su sitio web, a sus redes sociales.</p>
                                </ul>
                            </section>
                        </article>
                    </div>
                ...
                <div class="row gx-5">
                    ...
                    <div class="col-lg-8">
                        ...
                        <article>
                            ...
                            <section class="mb-5">
                                <ul>
                                    <li class=" mb-4">No hagas una campaña, ni dos, ni tres, haz una de GRAN IMPÁCTO, nosotros te decimos cómo.</li>
                                    <li class=" mb-4">Hacemos de tu marca, producto o servicio una EXPERIENCIA VIVENCIAL, tenemos el equipo técnico y humano a tu disposición. Siempre hay una nueva forma de comunicar lo que quieres.</li>
                                    <li class=" mb-4">Te ayudamos, te asesoramos, te proponemos las cosas de otra manera. H2O tu Agencia de Mercadeo Estratégico.</li>
                ...
                <div class="row gx-5">
                    ...
                    <div class="col-lg-8">
                        ...
                        <article>
                            ...
                            <section class="mb-5">
                                <ul>
                                    <p class=" mb-4">¡Todos hablan me Marketing estratégico pero pocos saben como usarlo!</p>
                                    <li class=" mb-4">DISEÑAMOS, DESARROLLAMOS E IMPLEMENTAMOS ESTRATEGIAS buscando conocer las necesidades actuales y futuras de los clientes, identificando segmentos y potencializándolos.</li>
                                    <li class=" mb-4">Buscamos optimizar los presupuestos de las áreas de MERCADEO Y COMUNICACIONES convirtiéndoles en áreas más rentables y con un verdadero enfoque.</li>
                                </ul>
                            </section>
                        </article>
                        <!-- Comments section-->
                    ...
                    <div class="col-lg-8">
                        ...
                        <article>
                            ...
                            <header class="mb-4">
                                ...
                                <!-- Post meta content-->
                                <div class="text-muted fst-italic mb-2">El arte de la personalización</div>
                                <!-- Post categories-->
                            </header>
                            <section class="mb-5">
                                <ul>
                                    <li class=" mb-4">No toda imagen se ve bien, pero SU LOGO, se verá bien en todo. ¿Dónde se imagina su logo?
                ...
                <div class="row gx-5">
                    ...
                    <div class="col-lg-8">
                        ...
                        <article>
                            ...
                            <section class="mb-5">
                                <ul>
                                    <p class=" mb-4">Videos Institucionales, videos de inducción de personal para su empresa, videos especializados en temas como: Seguridad y Salud en el trabajo, Riesgo Psicosocial, Planes de Evacuación de Emergencias, Informativos entre otros.</p>
                ...
                <div class="row gx-5">
                    ...
                    <div class="col-lg-8">
                        ...
                        <article>
                            ...
                            <section class="mb-5">
                                <ul>
                                    <p class=" mb-4">Desarrollamos ideas virtuales y digitales para mejorar sus procesos de calidad como: Plataformas de medición, aplicaciones especializadas, animaciones 2D y 3D, inducciones on-line, minería de datos y mucho más.
                                    </p>
                                </ul>
                            </section>
                        </article>
