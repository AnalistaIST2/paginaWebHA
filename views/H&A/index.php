                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item">
                                    <a class="text-decoration-none link-dark stretched-link" href="contactenos.php">
                                        <img src="../../assets/img/inicio/IST_BIENVENIDA 2.png" class="d-block w-100" style="border-radius: 8px;" alt="...">

                                </div>
                                <div class="carousel-item">
                                    <img src="../../assets/img/inicio/IST_BIENVENIDA 3.png" class="d-block w-100" style="border-radius: 8px;" alt="...">
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="card h-100 shadow border-3">
                            ...
                            <div class="card-body p-4">
                                <center>
                                    ...
                                    <a class="text-decoration-none link-dark stretched-link" href="../OHS/#riesgoPsicosocial">
                        ...
                        <div class="card h-100 shadow border-3">
                            ...
                            <div class="card-body p-4">
                                <center>
                                    ...
                                    <a class="text-decoration-none link-dark stretched-link" href="../H2O/#inicio">
                        ...
                        <div class="card h-100 shadow border-3">
                            ...
                            <div class="card-body p-4">
                                <center>
                                    ...
                                    <a class="text-decoration-none link-dark stretched-link" href="../BPO/#seleccionPersonal">
                        ...
                        <div class="card h-100 shadow border-3">
                            ...
                            <div class="card-body p-4">
                                <center>
                                    ...
                                    <a class="text-decoration-none link-dark stretched-link" href="../OHS/#sistemaSST">
            ...
            <div class="container px-6 my-6">
                <div class="row">
                    <div class="col-lg-12 mb-12 mb-lg-12">
                        <h2 class="fw-bolder text-center m-4">Nuestras Áreas de Trabajo.</h2>
                    </div>
                    <div class="col-lg-12 mb-12 mb-lg-12">
                        <div class="row  row-cols-1 row-cols-md-2">
                            ...
                            <div class="col mb-4 h-100 text-center">
                                <div class="feature bg-light bg-gradient text-white rounded-3 mb-3">
                                    <a href="../BPO/">
                                        <img src="../../assets/img/BPO.png" width="130%">
                                    </a>
                                </div>
                            ...
                            <div class="col mb-5 mb-md-0 h-100 text-center">
                                <div class="feature bg-light bg-gradient text-white rounded-3 mb-3">
                                    <a href="../H2O/">
                                        <img src="../../assets/img/H2O.png" width="130%">
                                    </a>
                                </div>
                                <h2 class="h5">Estrategic Marketing Agency</h2>
                                <p class="mb-0" style="text-align: justify;">
                                    En nuestra línea de negocio H2O, nuestro factor persuasivo incrementa el éxito de las marcas, campañas e ideas que a diario nacen en su organización. Llegar a sus clientes internos y externos de manera amable y agradable, garantiza su posicionamiento en el mercado e incrementa su rentabilidad.</p>
                            </div>
                            <div class="col h-100 text-center">
                                <div class="feature bg-light bg-gradient text-white rounded-3 mb-3">
                                    <a href="../IST/">
                                        <img src="../../assets/img/IST.png" width="130%">
                                    </a>
                                </div>
                            ...
                            <div class="col-md-6 h-100 text-center" style="margin-top: 50px">
                                <div class="feature bg-light bg-gradient text-white rounded-3 mb-3">
                                    <a href="../SAT/">
            ...
            <div class="container px-5 my-5">
                <div class="row  justify-content-center">
                    <div class="col-lg-10 col-xl-7">
                        <div class="text-center">
                            <h2>Palabras desde Alta Gerencia</h2>
                            <br>
                            <div class="fs-4 mb-4 fst-italic">"Los sueños son de todos, pero cada quien debe apoyar a cumplir los sueños de otros, para así cumplir los propios de acuerdo al aprendizaje obtenido."</div>
                    ...
                    <hr><br>
                    <center>
                        <div class="fs-3 fw-bold text-dark py-3">Nuestra Ubicación Actual</div>
                        <aside class="row bg-dark bg-gradient rounded-3 p-3 p-sm-3 mt-3">
