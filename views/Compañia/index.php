    ...
    <main class="flex-shrink-0">
        ...
        <header class="py-2">
            <div class="container px-5">
                <center>
                    <h1 class="fw-bolder fs-2 mb-4">COMPAÑÍA</h1>
                </center>
                <hr>
            ...
            <div class="container px-5 my-5 shadow-lg p-3 mb-5 bg-body rounded">
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="lead fw-normal text-muted mb-0">Liderar en el mercado mediante la evolución e innovación continua de nuestros productos o servicios y en el crecimiento del talento humano.</p>
                    </div>
                </div>
            </div>
        </section>
